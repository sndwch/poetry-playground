...
class PDFGenerator:
    ...
    def __init__(self):
        ...
        registerFont(
            TTFont("arial-bold", "arialbd.ttf"),
        )
        registerFont(
            TTFont("arial-italic", "ariali.ttf"),
        )
        registerFont(
            TTFont("arial-bolditalic", "arialbi.ttf"),
        )
...
class MarkovPoemPDFGenerator(PDFGenerator):
    ...
    def generate_pdf(
        self, input_words: Optional[List[str]] = [], orientation: string = "landscape"
    ):
        self.drawn_strings = []
