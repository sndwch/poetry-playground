...
class PoemGenerator:
    ...
    def poem_line_from_markov(
        ...
        words_for_sampling: Optional[List[str]] = None,
    ...
    def poem_from_markov(
        ...
        words_for_sampling = input_words + phonetically_related_words(
            input_words, max_results_per_input_word=20
        )
        ...
        for i in range(num_lines):
            ...
            if words_for_sampling and random.random() > 0.4:
    ...
    def poem_line_from_word_list(
        self, word_list: List[str], max_line_length=35, connectors: Optional[List[str]] = None
    ) -> str:
